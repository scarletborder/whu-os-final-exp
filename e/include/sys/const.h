...
enum TTYMsgType {
	TTY_KHIT = 3001,
	TTY_GETCH, TTY_FLAGTEST, TTY_SCRCTL,
};

enum TTYSCRCTL {
	SCRCTL_CLEAR = 1, SCRCTL_INIT,
	SCRCTL_PUTCH, SCRCTL_SETBTM, SCRCTL_PUTCH_BTM,
	SCRCTL_CUR_MV, SCRCTL_CUR_SET,
	SCRCTL_SCRSET
};
...
#define BYTES_SHELL_WORKING_DIRECTORY 128
